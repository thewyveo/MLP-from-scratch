...
if __name__ == "__main__":
    with open("diabetes/diabetes-processed.csv", "r") as file:
        data = file.read()
    ...
    # run the code
    model, results = run_classification(data, optimizer=None, gdescent='minibatch', random_seed=None, metric_for_selection='accuracy')